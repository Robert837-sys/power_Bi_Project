...
![Dashboard Image v2](/images/Data_Jobs_v2.png)

[View interactive dashboard here on the power BI service](https://app.powerbi.com/groups/me/reports/8bdf8faa-ff59-47f7-93a6-a0768a543663?experience=power-bi)

## Introduction

Navigating the data job market can feel like a maze with information scattered everywhere. This dashboard (V2.0) is designed specifically for **Job Seekers, Job Transitioners, and Job Swappers** to cut through the noise using a real-world dataset of 2024 data science job postings—rich with details on titles, salaries, and locations. This project offers a streamlined, single-page interface to quickly explore crucial market trends and compensation insights.
...
This second iteration consolidates the dashboard into a **_single, focused page_**, designed to give job seekers the most critical market insights at their fingertips.
